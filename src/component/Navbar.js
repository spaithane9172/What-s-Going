  ...
  return (
    <nav className="bg-white w-full h-[5rem] px-[2.5rem] flex justify-between lg:justify-start items-center fixed">
      ...
      <ul
        ...
        } absolute flex-col top-[6.5vh] left-[60vw] bg-white w-[40vw] pl-[1rem] pb-[1rem] lg:h-[3.5rem] lg:pl-0 lg:pb-0 lg:relative lg:top-0 lg:left-0 lg:flex lg:flex-row lg:jus lg:bg-transparent lg:ml-[3rem] lg:w-fit`}
      >
        <Link to="/">
